...
def acquire():
    data = pd.read_csv('/Users/abc/Portfolio/Data pipeline/vehicles.csv')
    return data
...
#schedule it to run automatically at a desired frequency (daily, weekly, monthly, annually, etc.)
